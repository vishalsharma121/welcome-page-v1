          ...
          <div className="w-full sm:w-7/12 p-0 sm:p-3 flex items-center justify-center">
            <div className="w-full max-w-full sm:max-w-10/12">
              ...
              <p className="text-[12px] text-[#6E6E6E] mb-4">
                One Business Project is associated with one WhatsApp Business
                API Number
              </p>
              <form onSubmit={handleSubmit}>
                ...
                {newProjectName.length > 0 && (
                  <div
                    className={`absolute top-[10px] right-[10px] text-sm text-right ${
                      newProjectName.length === maxChars
                        ? "text-red-500"
                        : "text-gray-500"
                    }`}
                  >
                  ...
                  <div className="p-1">
                    <div className="w-8/12 pt-4">
                      ...
                      {project.number !== "N/A" ? (
                        ...
                        <span className="text-[16px] font-inter font-semibold leading-[1.235] tracking-[0.00735em] text-gray-500">
                          N/A
                        </span>
                      )}
                    </div>
